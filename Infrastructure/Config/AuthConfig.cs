...
namespace ArandanoIRT_Backend.Infrastructure.Config
{
    ...
    public static class AuthConfig
    {
        ...
        public static IServiceCollection AddJwtAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // Optional: Reads Issuer/Audience from configuration for validation if they are set during token generation.
            ...
            services.AddAuthentication(options =>
            {
                ...
                // This ensures JWT is used for authentication and challenges unless specified otherwise.
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(key), // Sets the key used for signature validation.
                ...
                options.Events = new JwtBearerEvents
                {
                    ...
                    OnAuthenticationFailed = context =>
                    {
                        ...
                        // Automatic token refresh logic is intentionally removed from this handler.
                    ...
                    OnChallenge = context =>
                    {
                        ...
                        // Example of fully customizing the response (currently commented out):
                        // context.HandleResponse(); // Prevents default 401 response handling.
                        // context.Response.StatusCode = StatusCodes.Status401Unauthorized;
                        // context.Response.ContentType = "application/json";
                        // await context.Response.WriteAsync("{\"error\":\"Unauthorized\", \"message\":\"Token validation failed or token missing.\"}");

                        // Allows the default challenge handling to proceed (usually returns a 401 status code).
                        return Task.CompletedTask;
                    }
                    // OnForbidden - Fires when authentication succeeds but authorization fails (403 Forbidden). Can be configured similarly.
                };
            });

            // Add Authorization policies here if needed using services.AddAuthorization(...).
